...
},
{
  ...
  "number": "2.4.5",
  "title": "",
  "body": "Sofa King has determined that when hundred sofas are produced their average cost in thousands of dollars per hundred sofas is determined by the function How many sofas should Sofa King produce in order to minimize average cost? Write a sentence or two interpreting your answer. Find the cost funtion, . You should check that the vertex of parabloa is . Since the parabola opens up, note that the vetex corresponds to to a minimum for . Therefore, to minimize average cost, Sofa King should produce 4.5(100) = 450 sofas. At this production level, Sofa King's (minimum) average cost is 8.9 thousand dollars per hundred sofas, or $89 per sofa. Sofa King's cost function is (in thousands of dollars).  "
},
{
  "id": "example-25",
  "level": "2",
